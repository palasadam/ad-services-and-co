...
import Logo from "./Logo"; // Assuming Logo is in a file named Logo.js
...
const NavigationItem = ({ href, children }) => {
  return (
    <Link
      ...
      even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-neutral-800 sm:even:pl-16 hover:text-custom-pink"
    >
      {children}
